...
路由配置在 [src/routers](https://github.com/chengkoi/spacebar/tree/master/src/routers) 文件下面：
...
- 默认根据后端接口返回的数据生成动态路由
- 如果想把路由变成本地，直接更改 [src/api/modules/login.ts => getAuthMenuListApi](https://github.com/chengkoi/spacebar/blob/master/src/api/modules/login.ts) 方法
