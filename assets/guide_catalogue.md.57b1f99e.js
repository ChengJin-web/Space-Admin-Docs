import{_ as s,o as n,c as a,U as l}from"./chunks/framework.adbdbaa5.js";const d=JSON.parse('{"title":"目录结构","description":"","frontmatter":{},"headers":[],"relativePath":"guide/catalogue.md","filePath":"guide/catalogue.md","lastUpdated":1689748195000}'),p={name:"guide/catalogue.md"},e=l(`<h1 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h1><h2 id="spacebar-目录说明-📚" tabindex="-1">Spacebar 目录说明 📚 <a class="header-anchor" href="#spacebar-目录说明-📚" aria-label="Permalink to &quot;Spacebar 目录说明 📚&quot;">​</a></h2><div class="language-txt"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">Spacebar</span></span>
